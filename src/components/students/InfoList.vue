<template>
  ...
  <el-form :model="form" :rules="rules" ref="form">
    <el-form-item label="姓名" :label-width="formLabelWidth" prop="name"> <!-- 需要校验就要绑定prop-->
      <el-input v-model="form.name" autocomplete="off"></el-input>
    </el-form-item>
    <el-form-item label="性别" :label-width="formLabelWidth" prop="sex">  <!-- 需要校验就要绑定prop-->
      <el-radio v-model="form.sex" label="1">男</el-radio>  <!-- radio 单选-->
      <el-radio v-model="form.sex" label="2">女</el-radio>
    </el-form-item>
    <el-form-item label="年龄" :label-width="formLabelWidth" prop="age"> <!-- 需要校验就要绑定prop-->
      <el-input v-model="form.age" autocomplete="off"></el-input>
    </el-form-item>
    <el-form-item label="父亲姓名" :label-width="formLabelWidth" prop="father"> <!-- 需要校验就要绑定prop-->
      <el-input v-model="form.father" autocomplete="off"></el-input>
    </el-form-item>
    <el-form-item label="母亲姓名" :label-width="formLabelWidth" prop="mather"> <!-- 需要校验就要绑定prop-->
      <el-input v-model="form.mather" autocomplete="off"></el-input>
    </el-form-item>
    <el-form-item label="入校时间" :label-width="formLabelWidth" prop="time"> <!-- 需要校验就要绑定prop-->
      <el-date-picker
         v-model="form.time"
    ...
    <el-form-item label="家庭住址" :label-width="formLabelWidth" prop="address"> <!-- 需要校验就要绑定prop-->
      <el-input v-model="form.address" autocomplete="off"></el-input>
    </el-form-item>
    <el-form-item label="联系方式" :label-width="formLabelWidth" prop="phone"> <!-- 需要校验就要绑定prop-->
